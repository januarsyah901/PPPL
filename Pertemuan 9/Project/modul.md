...
[https://www.selenium.dev/selenium/docs/api/java/org/openqa/selenium/interactions/Actions.html](https://www.selenium.dev/selenium/docs/api/java/org/openqa/selenium/interactions/Actions.html)
...
{
    Actions action = new Actions (driver);
    WebElement menu2 = driver.findElement(new By.ByLinkText("Main Item 2"));
    action.moveToElement (menu2).perform();

    WebElement menu_sub = driver.findElement(new By.ByPartialLinkText("SUB SUB LIST"));
    action.moveToElement (menu_sub).perform();

    WebElement menu_sub_sub = driver.findElement(new By.ByPartialLinkText("Sub Sub Item 1"));
...
[https://www.selenium.dev/selenium/docs/api/java/org/openqa/selenium/support/ui/ExpectedConditions.html](https://www.selenium.dev/selenium/docs/api/java/org/openqa/selenium/support/ui/ExpectedConditions.html)
...
Buat kode pengujian untuk studi kasus test case 1 dan 5 pada halaman web [https://practicetestautomation.com/practice-test-exceptions/](https://practicetestautomation.com/practice-test-exceptions/). (test case dijelaskan dalam halaman web).
